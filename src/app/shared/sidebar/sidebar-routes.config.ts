...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/estudios', title: 'Estudios', icon: 'icon-graduation', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/experiencia', title: 'Experiencia', icon: 'icon-mouse', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/cursos-y-certificados', title: 'Cursos', icon: 'icon-book-open', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/redes-sociales', title: 'RRSS', icon: 'icon-feed', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    // {
